...
sh RunUAT.sh BuildCookRun -project=$PROJECT_PATH/$PROJECT_FILE -Platform=$Platform -ClientConfig=$ClientConfig -addcmdline="-messaging" -Cook -Package -Compressed -UnversionedCookedContent -NoCompileEditor -build -stage -pak -archive -ArchiveDirectory=$ArchiveDirectory $*
